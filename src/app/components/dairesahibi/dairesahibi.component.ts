...
@Component({
  selector: 'app-dairesahibi',
  templateUrl: './dairesahibi.component.html',
  styleUrls: ['./dairesahibi.component.scss']
})
export class DaireSahibiComponent implements OnInit {
 ...
 Kaydet2() {
   if (this.secYonetici.key2 == null){
     ...
     this.fbServis.YoneticiEkle(this.secYonetici).then(d => {
       ...
       this.sonuc2.mesaj2 = "Yonetici Eklendi";
     })
   } else {
 ...
 Kaydet3() {
  if (this.secAidat.key3 == null){
    ...
    this.fbServis.YoneticiEkle(this.secYonetici).then(d => {
      ...
      this.sonuc3.mesaj3 = "Yonetici Eklendi";
    })
  } else {
  ...
  Sil2() {
    this.fbServis.YoneticiSil(this.secYonetici.key2).then(d => {
      this.sonuc2.islem2 = true;
      this.sonuc2.mesaj2 = "Yonetici Silindi";
      this.silme2 = false;
    });
  }
